...
단결된 팀, 침착함과 절박함의 적절한 조화, 그리고 상식을 뛰어넘는 헌신이 일을 완성시킨다. 장기적 관점을 가진 사람은 드물다. 당장 남들이 뭐라 할지 신경 쓰지 마라. 시간이 지나면서 그런 걱정은 자연스럽게 사라질 것이다.
...
팀이 정말로 중요한 어려운 일을 하는 것이, 딱히 중요하지 않은 쉬운 일을 하는 것보다 더 쉽다. 대담한 아이디어가 사람들에게 동기를 부여한다.

4. Incentives are superpowers; set them carefully.  
인센티브는 엄청난 힘을 발휘한다. 신중하게 설계하라.
...
확신이 있는 소수의 분야에 자원을 집중하라. 말은 쉽지만 이것을 실행하기는 정말 어렵다. 생각보다 많은 것들을 과감히 버려야한다.
...
헛소리나 관료주의를 마주할 때마다 단호히 맞서고, 다른 사람들도 함께 싸우게 하라. 조직 체계에 얽매여서 사람들끼리 효율적으로 일하지 못하는 상황을 만들지 마라.

8. Outcomes are what count; don’t let good process excuse bad results.
결과가 전부다. 좋은 프로세스가 나쁜 결과를 변명해 주지 않는다.
...
인재 영입에 더 많은 시간을 투자하라. 성장 속도가 빠른 잠재력 높은 인재에게 과감히 베팅하라. 머리가 좋은 것도 중요하지만 실제로 일을 해내는 능력이 있는지가 더 중요하다.
...
뛰어난 인재는 겉으로 보이는 것보다 훨씬 더 가치 있다. 다만, 조직 전체 성과에 미치는 실질적 영향으로 평가해야 한다.
...
복리의 지수적 성장은 마법과 같다. 특히 규모가 커질수록 복리 효과를 누리는 비즈니스를 만들어야 한다.

16. Get back up and keep going.
넘어져도 다시 일어나서 계속 전진하라.
